...
import com.video.selfads.Ads.banner.BannerAdLoadCallback;
import com.video.selfads.Ads.banner.SelfBannerAds;
...
public class SelfeAds {
    ...
    // Banner
    public static SelfBannerAds selfBannerAds;
...
//        }
    ...
    public static void preloadSelfBannerAd() {
        ...
        if (bannerArrays.size() == 0) {
            ...
            selfBannerAds = new SelfBannerAds(activity);
            isSelfBannerLoaded = true;
            selfBannerAds.load(activity, new BannerAdLoadCallback() {
                @Override
                public void onAdLoaded() {
                    isSelfBannerLoaded = true;
                }
